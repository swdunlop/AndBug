...
(function() {
  var after_timeout, crop_fjni, crop_jni, crop_pkg, edit_value, last, layout_fjni, layout_frame, layout_items, layout_jni, layout_slot, layout_slots, layout_thread, layout_value, object_view, popout, popout_view, post_json, sequence_view, show_thread, submit_value, value_view,
    __slice = [].slice;
  ...
  submit_value = function(doc) {
    ...
    req.success(function() {
      return doc.css('color', 'green').data('data', new_data);
    });
    req.error(function(_, status, error) {
      doc.css('color', 'red').text(old_data);
      return console.log(ref, new_data, error || status);
    });
